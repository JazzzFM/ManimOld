...
class AnimationSevenP2(GraphScene):
    CONFIG = {
        "x_min" : 0,
        "x_max" : 10,
    ...
    def introduce_graph(self, graph, origin):
        ...
        brace_text = brace.get_text("Posición obtenida")
        ...
        text_1 = TextMobject("$\\frac{\\text{m}}{\\text{s}}$")
        text_2 = TextMobject("$\\frac{\\text{metro}}{\\text{segundo}}$")
    ...
    def get_change_lines(self, curr_time, delta_t=4):
        ...
        DeltaV = brace_1.get_text("$\\Delta s$")
