...
class Testing(ThreeDScene):
    ...
    def construct(self):
        ...
        self.wait(1)
        self.move_camera(phi = 120 * DEGREES, theta = 45 * DEGREES, run_time = 4)
        self.wait(2)
        ...
        dotM = Dot()
        dotN = Dot()
        dotM.set_color(BLACK)
        dotN.set_color(BLACK)
        #dotM.set_stroke(10)
        #dotN.set_stroke(10)
        dotM.move_to(Vector3D( 1, 1, 1))
        dotN.move_to(Vector3D(-1,-1,-1))
        ...
        self.move_camera(phi = 45 * DEGREES, theta = 90 * DEGREES, run_time = 4)
        self.wait(2)
        self.add(dotM)
        self.wait(1)
        self.play(ReplacementTransform(dotM.copy(), dotN))
        self.wait(1)
        self.begin_ambient_camera_rotation(rate = 0.5)            #Start move camera
        self.wait(6)
        self.stop_ambient_camera_rotation()
        self.play(ReplacementTransform(path, circle))
        self.wait(2)          
